...
public class HotFragmentTurnBean {
    ...
    public static class DataBean {
        /**
         * id : 18444
         * name : 【1】电影交易打包-12.20-12.25
         * commonTitle :
         * imgUrl : http://p0.meituan.net/mmc/5b443d7c11d9afcc3d4611f895d4408393107.jpg
         * imgUrlSize : (640, 150)
         * bigImgTypeUrl : http://p0.meituan.net/mmc/5b443d7c11d9afcc3d4611f895d4408393107.jpg
         * bigImgUrlSize : (640, 150)
         * app : movie
         * type : 3
         * typeDesc : 链接到应用内部页面
         * standIdList : [11]
         * startTime : 1482166800000
         * endTime : 1482681540000
         * level : 1
         * newUser : -1
         * closable : 2
         * channelType : 0
         ...
         * businessName :
         * businessIds :
         * url : meituanmovie://www.meituan.com/web?url=http://i.meituan.com/firework/zu1482204589
         * movieIdList : []
         */
