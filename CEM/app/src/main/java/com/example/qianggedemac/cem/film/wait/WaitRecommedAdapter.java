...
public class WaitRecommedAdapter extends RecyclerView.Adapter<WaitRecommedAdapter.WRViewHolder> {
    private Context mContext;
    private RecommedBean mRecommedBean;

    public WaitRecommedAdapter(Context context) {
        mContext = context;
    }
    ...
    @Override
    public WaitRecommedAdapter.WRViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(WaitRecommedAdapter.WRViewHolder holder, int position) {
