...
public class WaitWishRefreshAdapter extends RecyclerView.Adapter<WaitWishRefreshAdapter.WWViewHolder> {
    private Context mContext;
    private WishBean mWishBean;

    public WaitWishRefreshAdapter(Context context) {
        mContext = context;
    }
    ...
    @Override
    public WaitWishRefreshAdapter.WWViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(WaitWishRefreshAdapter.WWViewHolder holder, int position) {
