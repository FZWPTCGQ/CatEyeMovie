...
public class FabCreateActivity extends BaseActivity {
    ...
    protected int setLayout() {
        return R.layout.activity_fab_create;
    }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(textContent)) {
                    Toast.makeText(FabCreateActivity.this, "您的输入为空!", Toast.LENGTH_SHORT).show();
                    return;
                }
                editText.setText("");
